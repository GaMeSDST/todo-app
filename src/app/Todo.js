export default function Todo({ index, value, checked }) {
    return (
        <>
            <div className="group">
                <div className="flex flex-row items-center mt-2 border-b-2 border-[#e6e5ea] dark:border-[#37394e]">
                    ...
                    ></input>
                    <button className="max-[650px]:bg-[url(../../public/icon-cross.svg)] max-[650px]:right-[1.5rem] group-hover:bg-[url(../../public/icon-cross.svg)] w-[18px] h-[18px] absolute right-12 top-[14.5rem] scale-125"></button>
                </div>
            </div>
        </>
    );
